...
{ 	
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_0|GPIO_Pin_1;
	...
	ADC_InitStructure.ADC_ContinuousConvMode = ENABLE;	//是否开启连续转换模式
    ...
    ADC_RegularChannelConfig(ADC1, ADC_Channel_11, 3, ADC_SampleTime_7Cycles5);
